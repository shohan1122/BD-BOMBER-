...
def logo():
    ...
    print("\033[94m│     \
 '\033[95;1m'$$$$$$$  /$$$$$$$        /$$$$$$$   /$$$$$$  /$$      /$$ /$$$$$$$  /$$$$$$$$ /$$$$$$$ 
|'\033[97;1m' $$__  $$| $$__  $$      | $$__  $$ /$$__  $$| $$$    /$$$| $$__  $$| $$_____/| $$__  $$
| '\033[92;1m'$$  \ $$| $$  \ $$      | $$  \ $$| $$  \ $$| $$$$  /$$$$| $$  \ $$| $$      | $$  \ $$
|'\033[93;1m' $$$$$$$ | $$  | $$      | $$$$$$$ | $$  | $$| $$ $$/$$ $$| $$$$$$$ | $$$$$   | $$$$$$$/
'\033[91;1m'| $$__  $$| $$  | $$      | $$__  $$| $$  | $$| $$  $$$| $$| $$__  $$| $$__/   | $$__  $$
'\033[96;1m'| $$  \ $$| $$  | $$      | $$  \ $$| $$  | $$| $$\  $ | $$| $$  \ $$| $$      | $$  \ $$
'\033[94;1m'| $$$$$$$/| $$$$$$$/      | $$$$$$$/|  $$$$$$/| $$ \/  | $$| $$$$$$$/| $$$$$$$$| $$  | $$
'\033[92;1m'|_______/ |_______/       |_______/  \______/ |__/     |__/|_______/ |________/|__/  |__/
                                                                                         
                                                                                         
                                                                                         
  \033[94m   │".center(columns+15))
    print("\033[94m│                              \033[94m          │".center(columns+9))
    print("\033[94m│ \033[95mAuthor : shohan1122                     \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/shohan1122 \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : SHOHAN             \033[37mV3.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
